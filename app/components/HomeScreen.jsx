  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-xl p-8 space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-500 mt-2">Your Personal AI Tutor</p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 p-6 rounded-xl text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800">Master a Topic</h2>
        <p className="text-gray-600 text-sm mt-1 mb-4">
          Struggling with a concept? Let's break it down together.
        </p>
        <button
          onClick={onStartTopicMastery}
      ...
      <div className="bg-amber-50 border border-amber-200 p-6 rounded-xl">
        ...
        <div className="flex flex-col items-center">
          ...
          <button
            ...
            className="w-24 h-24 bg-gradient-to-br from-amber-400 to-red-500 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300"
          >
            <svg
              xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)"
              className="h-10 w-10"
          ...
          <p className="mt-2 text-sm text-gray-500 h-5">
            {imageFile ? `Selected: ${imageFile.name}` : "Upload a photo"}
          </p>
        </div>
        <div className="relative flex items-center justify-center my-4">
          ...
          <div className="relative bg-amber-50 px-2 text-sm text-gray-500">
            OR
          </div>
        </div>
